...
public:
    ...
    typedef dlsc_axi4lb_tlm_master_template<uint32_t,uint32_t>::socket_type socket_type;
...
SP_CTOR_IMP(__MODULE__) /*AUTOINIT*/, socket("socket") {
    ...
    master->axi_ar_id.bind(axi_ar_id);
    ...
    master->axi_aw_id.bind(axi_aw_id);
