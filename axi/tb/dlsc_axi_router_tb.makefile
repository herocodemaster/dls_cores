...
sims1:
	$(MAKE) -f $(THIS) V_PARAMS="INPUTS=2"
	$(MAKE) -f $(THIS) V_PARAMS="OUTPUTS=2"
	$(MAKE) -f $(THIS) V_PARAMS="INPUTS=2 OUTPUTS=2"
	$(MAKE) -f $(THIS) V_PARAMS="OUTPUTS=2 LANES=2"

sims2:
	$(MAKE) -f $(THIS) V_PARAMS="INPUTS=2 OUTPUTS=2 LANES=2"
